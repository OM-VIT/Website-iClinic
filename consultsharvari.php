...
if(isset($_POST['name'])){
    ...
    $phone = $_POST['phone'];
    $desc = $_POST['desc'];
    $sql = "INSERT INTO `consultations`.`sharvari` (`name`, `age`, `gender`, `email`, `phone`, `other`, `dt`) VALUES ('$name', '$age', '$gender', '$email', '$phone', '$desc', current_timestamp());";
    // echo $sql;
...
<body>
    ...
    ?>
        ...
        <form action="consultsharvari.php" method="post">
